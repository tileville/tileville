          ...
          {signer === null ? (
            ...
            <DropdownMenu.Trigger>
              <button
                ...
                className="focus-visible-bg-primary-30 focus-bg-primary-30 hover-bg-primary-30 bg-primary-30 flex cursor-pointer items-center justify-center gap-2 rounded-[15px] border-2 border-transparent bg-opacity-30 px-[15px] py-[3.5px] font-mono leading-none text-white outline-none hover:border-primary hover:shadow-[0_0_8px_hsl(var(--primary))] hover:shadow-[0_0_8px_hsl(var(--primary))] focus:border-primary focus:shadow-[0_0_8px_hsl(var(--primary))] focus-visible:shadow-[0_0_8px_hsl(var(--primary))]"
              >
                {/* {icon} */}
                {/* {text} */}
                Connect
