...
// Competition image component
const CompetitionImage = ({ posterUrl }: { posterUrl: string }) => (
...
export const CompetitionCard = ({
  ...
  return (
    <div
      ...
      key={competition.id}
    >
      <CompetitionImage posterUrl={competition.poster_url || ""} />
      <CompetitionDetails
        competition={competition}
        competitionStatus={competitionStatus}
      />
