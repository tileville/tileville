...
const mockCompetitions = [
  {
    ...
    description:
      "Compete against the best players in TileVille and win amazing prizes!",
  ...
  },
  {
    ...
    description:
      "A friendly competition for newcomers to TileVille. Learn the basics and win prizes!",
  ...
  },
  {
    ...
    description:
      "How fast can you build? Complete the challenge in the shortest time to win!",
