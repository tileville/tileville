                    ...
                    >
                      ...
                      <div className="col-span-2 p-4">
                        <div className="flex h-full items-start">
                          ...
                          <Button
                            className="mx-auto w-full cursor-pointer whitespace-nowrap rounded-md border-2 border-primary bg-primary bg-opacity-30 py-2 text-center font-mono leading-none text-white hover:shadow-[0_0_8px_hsl(var(--primary))]"
                            onClick={() => {
