const GlossaryItem = ({
  ...
  <div className="mb-6">
    <h3 className="mb-1 text-lg font-bold text-primary">{term}</h3>
  ...
  return (
    <div className="mx-auto max-w-[1200px] p-6 pt-20">
      ...
      <p className="mb-12 text-lg">
        A comprehensive guide to terms used in the TileVille ecosystem
      </p>
      ...
      <div className="grid grid-cols-1 gap-x-12 md:grid-cols-2">
        ...
        <div className="col-span-1">
          ...
          <h2 className="mb-6 mt-10 text-2xl font-bold text-primary">
            Competitions
          </h2>
      ...
      <div className="mt-12 rounded-lg bg-primary/20 p-8">
